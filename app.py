...
# SQLite 데이터베이스 설정
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///game_history.db' # SQLite 데이터베이스 파일 설정
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False # 데이터베이스 변경 추적기능 비활성화
db = SQLAlchemy(app) # flask랑 연결
